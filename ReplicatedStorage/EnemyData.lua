	...
	[1] = {
		...
		Templates = {
			["Story_Part1_Intro"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "System", Text = "Year 845. The Shiganshina District." },
					{ Speaker = "Hannes", Text = "Run! The Armored Titan has broken through Wall Maria!" },
					{ Speaker = "Hannes", Text = "Get to the boats, I'll hold them off!" }
				},
				Choices = {"Flee to the boats."},
				Rewards = { XP = 50 } 
			},
			...
			["Story_Part1_Mid"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Armin Arlert", Text = "We made it past the debris, but there are titans everywhere!" },
					{ Speaker = "Armin Arlert", Text = "We have to fight our way to the evacuation ships!" }
				},
				Choices = {"Draw your blades."}
			},
			...
			["Story_Part1_PreBoss"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Eren Yeager", Text = "I'll wipe them out... Every last one of them!" },
					{ Speaker = "System", Text = "A massive Abnormal Titan crashes through the central plaza, blocking your path to the docks." }
				},
				Choices = {"Engage the Abnormal!"}
			},
			...
			["Story_Part1_Outro"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "System", Text = "You survived the fall of Shiganshina. Five years pass." },
					{ Speaker = "System", Text = "Determined to fight back, you enroll in the 104th Cadet Corps." }
				},
				Choices = {"Begin Training."},
				Rewards = { Dews = 100, XP = 100 }
			}
		},
		Missions = { 
	...
	[2] = {
		...
		Templates = {
			["Story_Part2_Intro"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Keith Shadis", Text = "Who the hell are you?! You look like nothing but titan fodder!" },
					{ Speaker = "Keith Shadis", Text = "Before I even let you touch a blade, let's see if you can even stand upright!" },
					{ Speaker = "Keith Shadis", Text = "Get on the suspension wires. If you fall, you're shipping out to the fields tomorrow!" }
				},
				Choices = {"Step up to the wires."}
			},
			...
			["Story_Part2_PostBalance"] = {
				IsDialogue = true,
				Dialogues = {
					{ Speaker = "Keith Shadis", Text = "Tch. Barely passable. At least you didn't crack your skull open." },
					{ Speaker = "Keith Shadis", Text = "Take this blade and prove to me you aren't completely useless against a target!" }
				},
				Choices = {"Grip your blade."},
				Rewards = { ItemName = "Cadet Training Blade", Amount = 1 } 
			},
			...
			["Story_Part2_Mid"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Keith Shadis", Text = "Not terrible... Now let's see how you handle armored targets!" },
					{ Speaker = "Keith Shadis", Text = "These dummies are reinforced. Aim true or you'll dull your blades!" }
				},
				Choices = {"Proceed to next dummy."}
			},
			...
			["Story_Part2_PreBoss"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Keith Shadis", Text = "Enough playing around!" },
					{ Speaker = "Keith Shadis", Text = "I'll test your mettle personally! Come at me with intent to kill!" }
				},
				Choices = {"Face the Commandant!"}
			},
			...
			["Story_Part2_Outro"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Erwin Smith", Text = "You survived training. I've been watching your progress." },
					{ Speaker = "Erwin Smith", Text = "The Scout Regiment could use someone with your resolve. Here is your graduation allowance." }
				},
				Choices = {"Accept the allowance."},
				Rewards = { Dews = 1000, XP = 1000 } 
			}
		},
		Missions = { 
	...
	[3] = {
		...
		Templates = {
			["Story_Part3_Intro"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Levi Ackerman", Text = "Listen up. We are pushing out past Wall Rose." },
					{ Speaker = "Levi Ackerman", Text = "Stay in formation. Do exactly as I say and you might live to see tomorrow." }
				},
				Choices = {"Understood, Captain."}
			},
			...
			["Story_Part3_Mid"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Armin Arlert", Text = "Wait... the entire right flank was wiped out!" },
					{ Speaker = "Armin Arlert", Text = "The black smoke signals... Something intelligent is coming, and it's fast!" }
				},
				Choices = {"Prepare for battle."}
			},
			...
			["Story_Part3_PreBoss"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Erwin Smith", Text = "FIRE THE TRAP!" },
					{ Speaker = "System", Text = "A volley of specialized wire traps pierce the Female Titan." },
					{ Speaker = "Erwin Smith", Text = "...It failed. The Female Titan is crystallizing her nape! Brace yourselves, she's breaking free!" }
				},
			...
			["Story_Part3_Outro"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Hange Zoe", Text = "Incredible work bringing her down!" },
					{ Speaker = "Hange Zoe", Text = "She encased herself in a crystal, but we can study it. Take this cloak, you've earned it." }
				},
				Choices = {"Accept the cloak."},
				Rewards = { ItemName = "Scout Regiment Cloak", Amount = 1 } 
			}
		},
		Missions = { 
	...
	[4] = {
		...
		Templates = {
			["Story_Part4_Intro"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Levi Ackerman", Text = "The government is corrupt. Kenny the Ripper is hunting us down with Anti-Personnel ODM gear." },
					{ Speaker = "Levi Ackerman", Text = "They have guns. Do not hesitate, or you will die." }
				},
				Choices = {"Understood."}
			},
			...
			["Story_Part4_Mid"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Hange Zoe", Text = "We've entered the Reiss family's Crystal Caverns." },
					{ Speaker = "Hange Zoe", Text = "The structure is fragile. Watch your ODM anchors, and watch your back." }
				},
				Choices = {"Move deeper into the caverns."}
			},
			...
			["Story_Part4_PreBoss"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Kenny Ackerman", Text = "Yo, Levi! You really brought a bunch of brats down here?" },
					{ Speaker = "Kenny Ackerman", Text = "Lieutenant! Shred 'em to pieces!" }
				},
				Choices = {"Engage the Lieutenant!"}
			},
			...
			["Story_Part4_Outro"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Levi Ackerman", Text = "It's over. Kenny is dead." },
					{ Speaker = "Levi Ackerman", Text = "I recovered this from his body... A Titan Serum. I'm entrusting it to the Commander." }
				},
				Choices = {"Acknowledge."},
				Rewards = { ItemName = "Standard Titan Serum", Amount = 1 } 
			}
		},
		Missions = { 
		...
		Templates = {
			["Story_Part5_Intro"] = { 
				...
				Dialogues = {
					...
					{ Speaker = "Erwin Smith", Text = "Charge the Beast Titan!" }
				},
				Choices = {"Charge!"}
			},
			...
			["Story_Part5_Mid"] = { 
				...
				Dialogues = {
					...
					{ Speaker = "Levi Ackerman", Text = "I will take down the Beast Titan." }
				},
				Choices = {"Trust Levi."}
			},
			...
			["Story_Part5_PreBoss"] = { 
				...
				Dialogues = {
					...
					{ Speaker = "Armin Arlert", Text = "Use the Thunder Spears! We have to blow off his armor!" }
				},
			...
			["Story_Part5_Outro"] = { 
				...
				Dialogues = {
					...
					{ Speaker = "Hange Zoe", Text = "And we found out the truth in the basement... The world outside is our enemy." }
				},
				Choices = {"Look toward the ocean."},
				Rewards = { Dews = 5000, XP = 5000 } 
			}
		},
		Missions = { 
	...
	[7] = {
		...
		Templates = {
			["Story_Part7_Intro"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Pieck Finger", Text = "Look at them scramble..." },
					{ Speaker = "Pieck Finger", Text = "Marleyan Airships are dropping troops right on top of Shiganshina! Secure the Founder!" }
				},
				Choices = {"Defend Shiganshina!"}
			},
			...
			["Story_Part7_Mid"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Zeke Yeager", Text = "Eren! I'm here! Protect me while I reach you!" },
					{ Speaker = "Zeke Yeager", Text = "Don't let them take the Anti-Titan Cannons!" }
				},
				Choices = {"Intercept the cannons!"}
			},
			...
			["Story_Part7_PreBoss"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Porco Galliard", Text = "You devils... I'll chew you all to pieces!" },
					{ Speaker = "Porco Galliard", Text = "Feel the power of the Jaw Titan!" }
				},
				Choices = {"Engage the Jaw Titan!"}
			},
			...
			["Story_Part7_Outro"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Eren Yeager", Text = "Zeke... I've touched you." },
					{ Speaker = "Eren Yeager", Text = "The Rumbling... begins now." }
				},
				Choices = {"Watch in horror."},
				Rewards = { ItemName = "Clan Blood Vial", Amount = 1 } 
			}
		},
		Missions = { 
	...
	[8] = {
		...
		Templates = {
			["Story_Part8_Intro"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Eren Yeager", Text = "Hear me, all Subjects of Ymir. My name is Eren Yeager." },
					{ Speaker = "Eren Yeager", Text = "I have undone the hardening of the walls of Paradis Island. I will trample every inch of the world beyond this island." }
				},
				Choices = {"Jump from the flying boat."}
			},
			...
			["Story_Part8_Mid"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Armin Arlert", Text = "We're on the Founding Titan's back!" },
					{ Speaker = "Armin Arlert", Text = "But Ymir... she's summoning the past Nine Titans to defend it!" }
				},
				Choices = {"Fight the husks!"}
			},
			...
			["Story_Part8_PreBoss"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "System", Text = "A massive skeletal structure erupts from the bone." },
					{ Speaker = "System", Text = "The Doomsday Titan stares down at you. This is the end." }
				},
				Choices = {"Dedicate your heart!"}
			},
			...
			["Story_Part8_Outro"] = { 
				IsDialogue = true, 
				Dialogues = {
					{ Speaker = "Armin Arlert", Text = "It's over... We stopped the Rumbling." },
					{ Speaker = "Armin Arlert", Text = "But the price we paid... was it worth it?" }
				},
				Choices = {"Rest."},
				Rewards = { ItemName = "Ymir's Clay Fragment", Amount = 1 } 
			}
		},
		Missions = { 
